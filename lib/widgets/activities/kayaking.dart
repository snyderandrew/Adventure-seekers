...
class Kayaking extends StatefulWidget {
  @override
  _KayakingState createState() => _KayakingState();
}

class _KayakingState extends State<Kayaking> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: GestureDetector(
        ...
        child: Container(
            ...
            width: 120.0,
            height: 30.0,
            child: Center(child: Text('Kayaking'))),
      ),
    );
  }
}
