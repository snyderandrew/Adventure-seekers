...
class Snowboarding extends StatefulWidget {
  @override
  _SnowboardingState createState() => _SnowboardingState();
}

class _SnowboardingState extends State<Snowboarding> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: GestureDetector(
        ...
        child: Container(
            ...
            width: 120.0,
            height: 30.0,
            child: Center(child: Text('Snowboarding'))),
      ),
    );
  }
}
