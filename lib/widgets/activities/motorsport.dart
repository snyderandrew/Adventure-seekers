...
class MotorSport extends StatefulWidget {
  @override
  _MeTooState createState() => _MeTooState();
}

class _MeTooState extends State<MotorSport> {
  @override
  Widget build(BuildContext context) {
    return Container(
      child: GestureDetector(
        ...
        child: Container(
            ...
            width: 120.0,
            height: 30.0,
            child: Center(child: Text('Motorsports'))),
      ),
    );
  }
}
